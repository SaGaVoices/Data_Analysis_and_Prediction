...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 13 22:48:39 2019
...
X_train = pd.DataFrame(preprocessing.scale(X_train.iloc[:,1:]),columns = cols[1:])
X_test = pd.DataFrame(preprocessing.scale(X_test.iloc[:,1:]),columns = cols[1:])
# In[36]:
...
multiple_linear_regression(X_train,X_label_train,X_test,X_label_test)
